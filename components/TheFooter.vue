<template>
  <footer class="container mx-auto px-6 py-2 text-gray-100">
    <section class="justify-between items-center mx-auto md:flex-row">
      <div
        class="px-4 py-6 md:flex md:items-center md:justify-between border mt-4"
      >
        <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center"
          >© 2023 tanved. All rights reserved
        </span>
        <div
          class="flex justify-center items-center mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse"
        >
          <button
