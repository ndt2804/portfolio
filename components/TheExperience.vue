<template>
  <div class="bg-white dark:bg-zinc-800">
    <div class="py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div
        class="mt-10 max-w-4xl mx-auto grid gap-5 lg:grid-cols-2 lg:max-w-none"
      >
        <div
          class="flex flex-col shadow-lg overflow-hidden border rounded-2xl mx-12"
        >
          <div
      ...
      <div
        class="relative h-full w-full flex items-center justify-center pt-12"
      >
        <div
